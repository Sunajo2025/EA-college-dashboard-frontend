...
const Header = ({ isSidebarOpen, toggleSidebar, user, onSignout }) => {
  ...
  return (
    <header
      className={`bg-white dark:bg-zinc-900 shadow-sm fixed top-0 right-0 z-10 transition-theme duration-300 ${
      ...
      <div className="flex justify-between items-center px-6 py-3">
        ...
        <div className="flex items-center gap-5 relative">
          ...
          <button
            ...
            className="p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 hover:text-indigo-600 dark:hover:text-indigo-400 transition-theme"
